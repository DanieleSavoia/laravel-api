...
@section('page-title')
	<h1 class="mb-3 mt-3">Projects</h1>
@endsection
...
@section('contents')
	<div class="wrapper w-100 mx-auto">
					...
					@foreach ($projects as $project)
						<tr>
							...
							<td>
								...
								<a href="{{ route('admin.projects.edit', ['project' => $project]) }}" class="btn btn-warning btn-sm fs-6">Edit</a>
		...
		<div class="d-flex justify-content-around">
		    {{-- Trashed projects --}}
		    <a href="{{ route('admin.projects.trashed') }}" class="btn btn-danger px-4 mb-3 fs-4"><i class="bi bi-trash3"></i>
			Trashed</a>
		    {{-- Create new project --}}
		    <a href="{{ route('admin.projects.create') }}" class="btn btn-success px-4 mb-3 fs-4"><i class="bi bi-file-earmark-plus"></i>
			Create </a>	
		</div>	
